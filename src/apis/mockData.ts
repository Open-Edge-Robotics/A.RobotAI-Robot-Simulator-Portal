...
export const mockSequentialFailedStatus: GetStatusResponseFinal = {
  ...
  currentStatus: {
    ...
    stepDetails: [
      ...
      { stepOrder: 2, status: "FAILED", progress: 20, failedAt: "2025-09-01T10:07:00Z" },
      { stepOrder: 3, status: "PENDING", progress: 0 },
      { stepOrder: 4, status: "PENDING", progress: 0 },
    ],
  },
...
export const mockParallelFailedStatus: GetStatusResponseFinal = {
  ...
  currentStatus: {
    ...
    groupDetails: [
      ...
      { groupId: 2, status: "FAILED", progress: 30, failedAt: "2025-09-01T11:07:00Z" },
      { groupId: 3, status: "PENDING", progress: 0 },
    ],
  },
};
...
export const mockSequentialStoppedStatus: GetStatusResponseFinal = {
  ...
  currentStatus: {
    ...
    stepDetails: [
      ...
      { stepOrder: 2, status: "STOPPED", progress: 40, stoppedAt: "2025-09-01T10:08:00Z" },
      { stepOrder: 3, status: "PENDING", progress: 0 },
      { stepOrder: 4, status: "PENDING", progress: 0 },
    ],
  },
...
export const mockParallelStoppedStatus: GetStatusResponseFinal = {
  ...
  currentStatus: {
    ...
    groupDetails: [
      ...
      { groupId: 2, status: "STOPPED", progress: 40, stoppedAt: "2025-09-01T11:08:00Z" },
      { groupId: 3, status: "PENDING", progress: 0 },
    ],
  },
};

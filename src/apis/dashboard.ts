...
const dashboardApiClient = createClient({
  baseURL: `/api${API_BASE_URL.dev}${ENDPOINTS.dashboard}`, // TODO: dashboard로 바꾸기
  //   enableAuth: true,
});

export const dashboardAPI = {
  // 대시보드 데이터 조회
  getSystemOverview: () => dashboardApiClient.get<GetDashboardOverviewResult>("/system-overview"),

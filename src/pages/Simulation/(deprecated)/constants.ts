...
//   { value: "smart", label: "기본" },
//   { value: "status", label: "상태" },
//   { value: "name", label: "이름" },
//   { value: "created", label: "생성일시" },
//   { value: "started", label: "시작일시" },
//   { value: "updated", label: "최종 업데이트일시" },
// ] as const;
...
// export const ALLOWED_PARAMS = ["sort", "order", "page", "size", "status", "patternType"] as const;

...
//   const validOrders = ORDER_OPTIONS.map((option) => option.value);
//   return validOrders.includes(value as OrderOption);
// };
...
// export const validateSort = (value: string | null): SortOption | null => {
//   return value && isSortOption(value) ? value : null;
// };

// export const validateOrder = (value: string | null): OrderOption | null => {
//   return value && isOrderOption(value) ? value : null;
// };
